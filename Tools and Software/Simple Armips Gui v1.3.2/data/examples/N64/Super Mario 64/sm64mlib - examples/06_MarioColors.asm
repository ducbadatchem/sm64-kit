// [ARMIPS 0.9+ w/ SM64 Macro Library] Change Mario Colors Example by Davideesk
...
.f_DmaCopy func_SetMarioColor, func_SetMarioColor_ROM_start, data_ROM_end
...
.f_testInput BUTTON_L, BUTTON_PRESSED, func_MarioColorLoop_end
